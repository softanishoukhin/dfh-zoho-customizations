...
|---|---|---|---|
| TC-01 | Field API name | Open Setup > Deals > fields | URL field API name is exactly `Pre_Need_Deal_URL` |
...
| TC-14 | Click twice | Click again on the TC-04 Deal | No duplicate products, no duplicate Contact Roles, no second Note on either Deal, Type unchanged; popup says "Products added: 0" |
